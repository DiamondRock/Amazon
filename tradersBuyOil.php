...
<?php
	...
	if(!empty($_POST['barrelsNum']) || !empty($_POST['commissionType']))
    {
		...
		{
			include ("tradersBuyTransaction.php");
		}
    }
?>
<html lang="en">
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
				...
				<form action="tradersBuyOil.php" method="post">
					<div class="container">
						<?php 
						...
						?>
						<label><b>Number of Barrels that the customer wants to buy:</b></label>
						<input type="text" name="barrelsNum" required><br>
						<label><b>How the customer wants to pay your commission:</b></label>
